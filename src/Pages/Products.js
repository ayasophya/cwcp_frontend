...
const ProductsList = () => {
  ...
  useEffect(() => {
    if (query) {
      ...
      const url = `${APIBaseUrl}/api/v1/categories/${categoryId}/products/filter?make=${make}&model=${model}&year=${year}`;
      fetch(url)
  ...
  const fetchAllProducts = () => {
      fetch(`${APIBaseUrl}/api/v1/categories/${categoryId}/products`)
          .then(response => response.json())
          .then(data => setProducts(data))
          .then(() => listOfProducts())
          .catch(error => console.error('Error fetching products:', error));
  ...
  const fetchAllSearchedProducts = (searchQuery) => {
      fetch(`${APIBaseUrl}/api/v1/categories/products/search?query=${encodeURIComponent(searchQuery)}`)
        .then(response => response.json())
        .then(data => setProducts(data))
        .catch(error => console.error('Error fetching products:', error));
  ...
  const fetchFilteredSearchedProducts = (searchQuery, make, model, year) => {
    fetch(`${APIBaseUrl}/api/v1/categories/${categoryId}/products/search?query=${encodeURIComponent(searchQuery)}&make=${encodeURIComponent(make)}&model=${encodeURIComponent(model)}&year=${encodeURIComponent(year)}`)
      .then(response => response.json())
      .then(data => setProducts(data))
      .catch(error => console.error('Error fetching products:', error));
  ...
  const handleFilterSubmit = async (event) => {
    ...
    if (query) {
      try {
        ...
        const url = `${APIBaseUrl}/api/v1/categories/${categoryId}/products/search?query=${encodeURIComponent(searchQuery)}&make=${encodeURIComponent(make)}&model=${encodeURIComponent(model)}&year=${encodeURIComponent(year)}`;
    ...
    const handleSearchSubmit = async (event) => {
      ...
      try {
        let url = `${APIBaseUrl}/api/v1/categories/${categoryId}/products/search?query=${encodeURIComponent(searchQuery)}&make=${encodeURIComponent(make)}&model=${encodeURIComponent(model)}&year=${encodeURIComponent(year)}`;
  ...
  const fetchProductsHighToLow = () => {
    fetch(`${APIBaseUrl}/api/v1/categories/${categoryId}/products/price_sort_high_to_low`)
      .then(response => response.json())
      .then(data => setProducts(data))
      .catch(error => console.error('Error fetching products:', error));
  }
  ...
  const fetchProductsLowToHigh = () => {
    fetch(`${APIBaseUrl}/api/v1/categories/${categoryId}/products/price_sort_low_to_high`)
      .then(response => response.json())
      .then(data => setProducts(data))
      .catch(error => console.error('Error fetching products:', error));
  }
